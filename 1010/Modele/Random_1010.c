...
int random_get_piece_1010(){
   // srand((uint16_t)SysTick->VAL);
    if((uint16_t)rand() <= UINT16_DIVISE_2/7){
        return 0;
    }
    if((uint16_t)rand() <= 2*UINT16_DIVISE_2/7){
        return 1;
    }
    if((uint16_t)rand() <= 3*UINT16_DIVISE_2/7){
        return 2;
    }
    if((uint16_t)rand() <= 4*UINT16_DIVISE_2/7){
        return 3;
    }
    if((uint16_t)rand() <= 5*UINT16_DIVISE_2/7){
        return 4;
    }
    if((uint16_t)rand() <= 6*UINT16_DIVISE_2/7){
        return 5;
    }
