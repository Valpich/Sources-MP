...
extern "C" {
     ...
     * Les valeurs sont 0 pour JAUNE, 1 pour ROUGE, 2 pour BLEU, 3 pour VERT, 4 pour CYAN, 5 pour VIOLET, 6 pour BLANC et 7 pour NOIR.
     */
    typedef enum Couleur_1010{
        JAUNE,ROUGE,BLEU,VERT,CYAN,VIOLET,BLANC,NOIR
    }Couleur_1010;
